...
function checkDay(hr: number){
    ...
    if(day == undefined || night == undefined || clockColor == undefined || dateColor == undefined) return null
...
function tellDate(t: any){
    ...
    if(dateHolder == undefined) return null
...
function tellTime(){
    ...
    if(clockHolder != undefined) {clockHolder.innerHTML = h + ":" + m + ":" + s}
